...
const CustomWoodPage = () => {
  ...
  <section className="px-[30px] md:px-[80px] lg:px-[100px] bg-[#F4F5F7]">
    <tr className="xs:gap-x-3 gap-x-6 flex  items-center  py-[40px]">
      ...
      <td className="h-[px] font-bold text-[#9F9F9F] xs:text-14 sm:text-15 text-16">| </td>
      <td>Oka Wood </td>
    </tr>
  </section>


<section className="px-[30px] max-w-[1240px] mx-auto grid pt-[55px] grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">

    <section className="">

      <section  className="flex  gap-x-7"> 
        <div className="flex-col">
          <div className=""><img src={wood1}/></div>
          <div className="pt-[32px]"><img src={wood2}/></div>
          <div className="pt-[32px]"><img src={wood3}/></div>
          <div className="pt-[32px]"><img src={wood4}/></div>
        </div>

        <div className="flex-grow"> <img src={bigOak} className="w-full"/> </div>
      </section>

      <section className=" pt-[60px]">
        <span className="text-24 font-bold border-b-3 border-yellow">Description</span>
        <div className="pt-5 text-18 text-start"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</div>
      </section>
    ...
    {/* Right side Content  */}
    <section>
        <h1 className="text-20 font-bold">Angelium Vermelho, Planing, Rounded Corners with Points of 68*68mm FSC* </h1>
        <div className="flex gap-x-6 pt-6">
            <div><img src={starGroup}/></div>
        <div> <img src={line}/></div>
        <div className="text-18"> 5 Customer Review</div></div>
...
{/* product specfication  section  */}
        <section className=" bg-[#F8F8F8] px-[25px] mt-[35px] ml-2"> 
            <div className="text-18 font-bold pt-[15px]">Product specifications</div>
