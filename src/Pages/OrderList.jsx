                        ...
                        >
                          ...
                          <td className="px-[24px] py-[24px] text-left text-14 font-semibold text-gray3">
                            <div className="flex gap-1 items-center justify-center">
                              <div className="">
                                <p className={`rounded-full ${rowData.status === 'Rejected' ? 'bg-[#FD5454]' : rowData.status === 'Pending' ? 'bg-[#FCBE2D]': 'bg-green1'} text-white px-[16px] py-[7px] text-14 font-bold text-center`}>
                                  {rowData.status}
                                </p>
                              </div>
                            </div>
