      ...
      <footer className="bg-[#E9E6D6] relative">
        ...
        <section className="footer-content">
          <div className="flex flex-wrap justify-center sm:justify-normal gap-y-12  text-[#000] mt-7 max-w-[1240px] px-[30px] mx- sm:mb-4 xs:mb-4">
            ...
            <div className=" w-[100%] sm:w-[50%] md:w-[25%] lg:w-[25%] xl:w-[25%]">
              <div className="mb-6 text-[18px] md:text-[20px] lg:text-[22px] xl:text-[22px] font-semibold text-[#000]">Contact Us</div>
            ...
            <div className=" w-[100%] sm:w-[50%] md:w-[25%] lg:w-[25%] xl:w-[25%]">
              <div className="mb-6 text-[18px] md:text-[20px] lg:text-[22px] xl:text-[22px] font-semibold text-[#000]">Chamber of Commerce</div>
        ...
        <div className="copyright-sect xs:flex-col-reverse flex justify-center items-center sm:gap-[30px] xs:gap-[30px] gap-[100px] py-[30px] px-[30px]">
          <div className="text-[14px] text-[#111727s]">Copyright © 2024 Hout Total</div>
          <img src={footerLogo} />
        </div>
      </footer>
    </>
