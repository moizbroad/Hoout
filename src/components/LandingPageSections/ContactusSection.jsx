      ...
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="px-[30px] md:px-[80px] lg:px-[100px] xl:px-[100px] pt-[30px] md:pt-[70px] lg:pt-[100px] xl:pt-[100px]">
          ...
          <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row gap-6 lg:gap-[4.5%] xl:gap-[4.5%]">
            ...
            <div className="w-[100%] md:w-[30%] lg:w-[30%] xl:w-[30%]">
              {" "}
              <ContactInputField value={state.first_name} color={'#fff'} onChange={(e) => {
                setState((prev) => ({
                  ...prev,
            ...
            <div className="w-[100%] md:w-[30%] lg:w-[30%] xl:w-[30%]">
              {" "}
              <ContactInputField value={state.last_name} color={'#fff'} onChange={(e) => {
                setState((prev) => ({
                  ...prev,
            ...
            <div className="w-[100%] md:w-[30%] lg:w-[30%] xl:w-[30%]">
              {" "}
              <ContactInputField value={state.email} onChange={(e) => {
                setState((prev) => ({
                  ...prev,
                  email: e.target.value
                }))
              }} color={'#fff'} placeholder="E-mail Address" />
            </div>
          </div>
          <div className="pt-[24px] md:pt-[24px] lg:pt-[60px] xl:pt-[60px] flex flex-col md:flex-row lg:flex-row xl:flex-row gap-6 md:gap-6 lg:gap-[10%] xl:gap-[10%]">
            ...
            <div className="w-[100%] md:w-[45%] lg:w-[45%] xl:w-[45%]">
              {" "}
              <ContactInputField value={state.company} onChange={(e) => {
                setState((prev) => ({
                  ...prev,
                  company: e.target.value
                }))
              }} color={'#fff'} placeholder="Company" />
            </div>
            <div className="w-[100%] md:w-[45%] lg:w-[45%] xl:w-[45%]">
              {" "}
              <ContactInputField value={state.phone_number} onChange={(e) => {
                setState((prev) => ({
                  ...prev,
                  phone_number: e.target.value
                }))
              }} color={'#fff'} placeholder="Phone Number" />
            </div>
          </div>
          <div className="pt-[24px] md:pt-[24px] lg:pt-[60px] xl:pt-[60px]">
            ...
            <div>
              {" "}
              <ContactInputField value={state.message} onChange={(e) => {
                setState((prev) => ({
                  ...prev,
                  message: e.target.value
                }))
              }} color={'#fff'} placeholder="Message*" />{" "}
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end px-[100px]">
          <div className=" border-[#fff] border-2  mt-[40px] ">
            {" "}
            <button className="text-18 px-16 py-2 text-[#fff] " onClick={handleSendQuery}> Send </button>
          </div>
        </div>
      </div>
    </section>
